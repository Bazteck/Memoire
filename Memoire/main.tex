...
\begin{document}
	...
	\begin{titlepage}
		...
		\fcolorbox{customBlue}{white}{%
			\begin{minipage}{0.8\textwidth}
				\centering
				\bfseries
				<<Adaptation dynamique des paramètres de transmission dans les réseaux LoRaWAN utilisant la couche physique LR-FHSS : une approche basée apprentissage par renforcement profond>>
			\end{minipage}%
		}
		
		\vspace{0.5cm}
		
		Présenté par :  {\bfseries Marthy Elysée BAZOUM}\\[0.3cm]
	...
	\include{sigles_et_abreviations}
	...
	\input{chapitres/01_contexte}
	\input{chapitres/02_lorawan_lrfhss}
	\input{chapitres/03_etat_art}
	\input{chapitres/04_optimisation.tex}
	\input{chapitres/05_evaluation}
